...
=======
    for (var i = 1; i <= numPhases; i++) {
        ...
        chart1svg_group = chart1svg.append("g");
        chart1svg_group.attr('transform', function(d,i){
        
            return "rotate("+ 90 +","+startPosX+","+startPosY+")";
        }).attr("class","plane");

        chart1svg_group.append("path")
...
>>>>>>> 1176cf8d182b5740c518750a6ccc00e95a59c410
